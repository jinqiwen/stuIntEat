...
Morris.Donut({
    element: 'graph-donut',
    data: [
        {value: 40, label: 'NO.4', formatted: '65%' },
        {value: 30, label: 'NO.6', formatted: '15%' },
        {value: 20, label: 'NO.20', formatted: '10%' },
        {value: 10, label: 'NO.24', formatted: '5%' },
        {value: 5, label: 'NO.13', formatted: '5%' }
    ],
    backgroundColor: false,
    labelColor: '#fff',
    colors: [
        '#4acacb','#6a8bc0','#5ab6df','#fe8676','#8968CD'
    ],
