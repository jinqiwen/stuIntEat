...
//    $('#reply_createTime').val((d.getMonth()+1)+'/'+d.getDate()+'/'+d.getFullYear());
	...
	for(var i = 0;i<json.length;i++){
		...
		/*result = result + '<li class="dropdown active" onclick="$(\'#test'+i+'\').toggle(500);" style="cursor:pointer;">';*/
		...
		//config sub menus
		/*result = result + "<li><ul class=\"list-unstyled menu-item\" id=\"test"+i+"\">";*/
		
		/*result = result + '<li class=\"dropdown active\">';*/
		var pic;
		switch(i)
		{
		case 0:
			pic = "sa-side-home";break;
		case 1:
			pic = "sa-side-typography";break;
		case 2:
			pic = "sa-side-widget";break;
		case 3:
			pic = "sa-side-table";break;
		case 4:
			pic = "sa-side-ui";break;
		case 5:
			pic = "sa-side-chart";break;
		default:
			pic = "sa-side-page";break;
		}
		

		/*result = result +"<ul class=\"list-unstyled menu-item\">";*/
		/*for(var j=0;j<json[i].mainMenu.length;j++){*/

			result = result + "<li><a href=\""+json[i].mainMenu.funcUrl +"\" class="+pic+' style="cursor:pointer;"><span class=\"menu-item\">'+json[i].mainMenu.functionName +'</span></a></li>';
