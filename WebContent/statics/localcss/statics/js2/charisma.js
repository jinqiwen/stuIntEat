...
//    $('#reply_createTime').val((d.getMonth()+1)+'/'+d.getDate()+'/'+d.getFullYear());
	...
	for(var i = 0;i<json.length;i++){
		...
		result = result + "<a class="+pic+'><span class=\"menu-item\">'+json[i].mainMenu.functionName +'</span></a>';
		result = result +"<ul class=\"list-unstyled menu-item\">";
		for(var j=0;j<json[i].subMenus.length;j++){
			result = result +"<li><a href=\""+json[i].subMenus[j].funcUrl +"\">"+json[i].subMenus[j].functionName+"</a></li>";
